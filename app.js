...
const dbUrl = "mongodb+srv://admin:admin@cluster0.gu429ye.mongodb.net/?retryWrites=true&w=majority";
...
app.post('/newpass', async (req, res) => {
    ...
    console.log(eemail);
    let check = await User.updateOne({ email: eemail }, { $set: { Password: newpass } });
    console.log(check);
